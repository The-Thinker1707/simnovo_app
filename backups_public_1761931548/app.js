/**
 EduConnect prototype server (advanced homepage compatible)
*/
...
app.listen(PORT, ()=>{ console.log('EduConnect prototype (advanced homepage) running at http://127.0.0.1:' + PORT); });
